...
from ..agents.research_agents import TrendFetcherAgent, NicheAnalystAgent
from ..agents.content_agents import ScriptWriterAgent, VideoGeneratorAgent, ThumbnailDesignerAgent
from ..agents.safety_agents import HumanInLoopAgent, ContentModerationAgent
from ..agents.distribution_agents import PlatformPublisherAgent, OpenClawAnnouncerAgent
...
async def initialize_agents():
    ...
    thumbnail_designer = ThumbnailDesignerAgent("thumbnail_designer_001", "ThumbnailDesignerAgent")
    
    # Create SafetyLayer agents
    hitl_agent = HumanInLoopAgent("hitl_001", "HumanInLoopAgent")
    moderation_agent = ContentModerationAgent("moderation_001", "ContentModerationAgent")
    
    # Create DistributionSwarm agents
    publisher_agent = PlatformPublisherAgent("publisher_001", "PlatformPublisherAgent")
    openclaw_announcer = OpenClawAnnouncerAgent("openclaw_001", "OpenClawAnnouncerAgent")
