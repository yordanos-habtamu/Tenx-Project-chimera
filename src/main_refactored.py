...
from .components.publishing_component import PublishingComponent, PublishingMonitoringComponent
...
async def initialize_components():
    ...
    trend_monitor_component = TrendMonitoringComponent("trend_monitor_main", "TrendMonitoringComponent")
    
    # Create content components
    content_component = ContentComponent("content_main", "ContentComponent")
    moderation_component = ContentModerationComponent("moderation_main", "ContentModerationComponent")
    
    # Create publishing components
    publishing_component = PublishingComponent("publishing_main", "PublishingComponent")
    publishing_monitor_component = PublishingMonitoringComponent("publishing_monitor_main", "PublishingMonitoringComponent")
...
async def main():
    ...
    logger.info("Following SRS-based architecture with services, components, and API layers")
    
    try:
        # Initialize all components
        registry = await initialize_components()
        ...
        workflow_result = await demonstrate_workflow()
