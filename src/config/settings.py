...
class Settings(BaseSettings):
    ...
    database_url: str = (
        "postgresql://chimera_user:chimera_password@localhost/chimera_db"
    )
    ...
    video_gen_endpoint: str | None = None
...
class APISettings:
    ...
    def cors_config(self) -> dict:
        ...
        return {
            "allow_origins": (
                ["*"] if self.settings.environment == Environment.DEVELOPMENT else []
            ),
